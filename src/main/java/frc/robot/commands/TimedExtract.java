...
public class TimedExtract extends Command {
  ...
  public TimedExtract(Climber climber) {
  ...
  public boolean isFinished() {
    ...
    if (m_climber.getClimberPosition() > Constants.kClimberArmsMaxExtract ||
         m_timer.hasElapsed(Constants.kClimberMaxExtractTime) == true)
      value = true;
    return value;
  }
}
